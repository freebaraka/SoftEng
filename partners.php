    ...
    <div class="dashboard-container">
        ...
        <aside class="sidebar">
            ...
            <ul>
                ...
                <li class="active"><a href="partners.php"><i class="fa-solid fa-handshake"></i> Partners</a></li>
        ...
        <main class="main-content">
            <header>
                <h1>Partners 🤝</h1>
                <p>All our partners supporting the SaveEat Initiative.</p>
            </header>
                    ...
                    <?php while ($row = $result->fetch_assoc()): ?>
                        <div class="partner-card">
                            <div class="partner-info">
                                ...
                                <p><i class="fa-solid fa-utensils"></i> Last Donation: <?= htmlspecialchars($row['last_food_donated']) ?></p>
                                <p><i class="fa-solid fa-clock"></i> <?= htmlspecialchars($row['donation_date']) ?></p>
                            </div>
                            <a href="partners.php?delete_id=<?= $row['id'] ?>" 
                               class="delete-btn"
